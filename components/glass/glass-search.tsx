...
// gauche et aux pastilles notification/profil à droite.
export function GlassSearchBar() {
  return (
    <div className="fixed top-5 right-32 left-20 z-20 lg:right-auto lg:left-1/2 lg:w-full lg:max-w-md lg:-translate-x-1/2 lg:px-4">
      <div className="flex items-center gap-2.5 rounded-full border border-white/15 bg-black/25 px-4 py-2.5 text-white shadow-[0_8px_32px_rgba(0,0,0,0.28)] backdrop-blur-xl backdrop-saturate-150">
